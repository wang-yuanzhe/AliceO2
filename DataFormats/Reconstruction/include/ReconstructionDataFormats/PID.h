...
GPUconstexpr() const char* sNames[NIDsTot + 1] = ///< defined particle names
  {"Electron", "Muon", "Pion", "Kaon", "Proton", "Deuteron", "Triton", "He3", "Alpha",
   "Pion0", "Photon", "K0", "Lambda", "HyperTriton", "Hyperhydrog4", "HyperHelium4", "XiMinus", "OmegaMinus", nullptr};
#endif
...
GPUconstexpr() const float sMasses[NIDsTot] = ///< defined particle masses
  {o2cp::MassElectron, o2cp::MassMuon, o2cp::MassPionCharged, o2cp::MassKaonCharged,
   ...
   o2cp::MassKaonNeutral, o2cp::MassLambda, o2cp::MassHyperTriton, o2cp::MassHyperhydrog4, o2cp::MassHyperHelium4, o2cp::MassXiMinus, o2cp::MassOmegaMinus};
...
class PID
{
 public:
  ...
  static constexpr ID HyperHelium4 = 15;
  static constexpr ID XiMinus = 16;
  static constexpr ID OmegaMinus = 17;
